...
public class BleAdapterService extends Service {
    ...
    //Once the  communication over Bluetooth with the peripheral device has completed,
    //  the result of the operation are received via a call back.
    private final BluetoothGattCallback gatt_callback = new BluetoothGattCallback() {

        //This method will be called whenever a connection to another device
