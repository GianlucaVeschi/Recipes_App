...
public class HorizontalDottedProgress extends View {
    ...
    private void createDot(Canvas canvas, Paint paint) {
        ...
        for(int i = 0; i < mDotAmount; i++ ){
            if(i == mDotPosition){      //Only one Big Dot per iteration
                canvas.drawCircle(10+(i*20), mBounceDotRadius, mBounceDotRadius, paint); //Big dots
            }else {
                canvas.drawCircle(10+(i*20), mBounceDotRadius, mDotRadius, paint); //Small dots
            }
        }
    ...
    private void startAnimation() {
        ...
        bounceAnimation.setDuration(100); //speedIteration
